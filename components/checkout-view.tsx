...
import { ArrowLeft, MapPin, Phone, Check, Plus } from 'lucide-react'
...
export function CheckoutView() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    let deliveryAddress: { mobile: string; fullAddress: string; label?: string }
    ...
    if (showNewAddress) {
      ...
      deliveryAddress = { mobile, fullAddress, label }
    } else {
                ...
                {showNewAddress && (
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        id="address"
                        placeholder="Enter your full address including street, landmark, city, and zip code"
                        value={fullAddress}
